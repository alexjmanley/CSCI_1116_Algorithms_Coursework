...
public class Exercise20_03 {
	...
	public static void main(String[] args) {
	    ...
	    //call new method 
	    String[][] stateCapital = shuffle(stateCapital1); 
	...
	public static String[][] shuffle(String[][]list){
		...
		String[][] newArray = new String[list.length][list.length]; 
		...
		for (int i = 0; i < list.length; i++) {
			newArray[i][0] = list1.get(i);
			newArray[i][1] = list2.get(i);
		}
		return newArray;
	}
}
